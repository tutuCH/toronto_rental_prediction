...
import { VsArrowRight, VsRefresh } from 'solid-icons/vs';
...
function Scripts() {
  const context = useContext(ServerContext);
  return [createComponent$1(HydrationScript, {}), ssr(_tmpl$$4), isIslands , createComponent$1(NoHydration, {
    get children() {
      return isServer && (      ssr(_tmpl$5, ssrHydrationKey(), ssrAttribute("src", escape(context.env.manifest["entry-client"][0].href, true), false)) );
    }
  }), isDev ];
}
...
function Head(props) {
  {
    return ssrElement("head", props, () => [props.children, createComponent$1(Meta, {}), createComponent$1(Links, {})], false);
  }
}
function Body(props) {
  {
...
function NotFound() {
  return ssr(_tmpl$$3, ssrHydrationKey(), escape(createComponent$1(A, {
    href: "/",
...
const Search = props => {
  ...
  return ssr(_tmpl$3, ssrHydrationKey(), escape(roomOptionDiv), escape(createComponent$1(VsArrowRight, {})));
};
...
const Result = props => {
  return ssr(_tmpl$$1, ssrHydrationKey(), `$${escape(props.price)}`, escape(createComponent$1(VsRefresh, {})));
};
...
const Landing = () => {
  ...
  return ssr(_tmpl$, ssrHydrationKey(), ssrAttribute("src", escape(background.path, true), false) + ssrAttribute("alt", escape(background.alt, true), false), !searched() ? escape(createComponent$1(Search, {
    onSearchChange: handleSearchChange,
    onPriceChange: handlePriceChange
  })) : escape(createComponent$1(Result, {
    onSearchChange: handleSearchChange,
    get price() {
      return price();
    }
